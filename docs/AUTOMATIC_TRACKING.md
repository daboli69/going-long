...
Repeated blocked checks and reference polling remain in local SQLite rather than being mirrored on every scan. Supabase receives frozen unique research picks, actionable alerts, outcomes and operational status. Existing cloud history is not deleted. This reduces ongoing database growth.
