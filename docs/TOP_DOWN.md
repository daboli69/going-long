...
Outside 90 minutes the decision state is pending_inactives and the proposed stake is zero. Inside the window both exact teams must have complete official_confirmed reports with official NFL URL, source hash, inactive player list and publication/review timestamps. The parser validates submitted official reports; no reliable automatic official report endpoint has been connected. A clock or generic injury status cannot grant clearance.
