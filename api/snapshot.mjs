...
const allowed=new Set(['history.json','data.json','nfl_betting.json','ncaa_lines.json','results.json','football_context.json','football_role_validation.json','savant_context.json','topdown_status.json']);
